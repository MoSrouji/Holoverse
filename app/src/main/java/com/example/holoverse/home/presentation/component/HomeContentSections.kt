...
import com.example.holoverse.home.presentation.HomeTab
import com.example.holoverse.home.presentation.HomeUiState
    ...
    ShimmerBox(
        ...
        if (courses.isEmpty() && !isLoading) {
            ...
            val displayCourses = if (isLoading && courses.isEmpty()) {
                List(3) { Courses(id = "shimmer_$it", name = "Loading...", specialization = "Loading...") }
            } else courses
