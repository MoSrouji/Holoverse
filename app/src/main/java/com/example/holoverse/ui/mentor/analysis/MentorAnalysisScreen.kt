    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                ...
                CourseMetric("Completion", String.format(Locale.getDefault(), "%.0f%%", course.completionRate * 100))
...
fun CoursePerformanceChart(completion: Float, progress: Float) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
            Box(modifier = Modifier.size(12.dp).background(barColor1, RoundedCornerShape(2.dp)))
            Spacer(modifier = Modifier.width(4.dp))
            Text("Completion Rate", style = MaterialTheme.typography.labelSmall)
            Spacer(modifier = Modifier.width(16.dp))
            Box(modifier = Modifier.size(12.dp).background(barColor2, RoundedCornerShape(2.dp)))
            Spacer(modifier = Modifier.width(4.dp))
