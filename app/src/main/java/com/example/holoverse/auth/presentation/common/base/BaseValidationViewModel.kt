package com.example.holoverse.auth.presentation.common.base
...
import com.example.holoverse.auth.presentation.common.validation.use_case.ValidateAge
import com.example.holoverse.auth.presentation.common.validation.use_case.ValidateEmail
import com.example.holoverse.auth.presentation.common.validation.use_case.ValidatePassword
import com.example.holoverse.auth.presentation.common.validation.use_case.ValidatePhone
import com.example.holoverse.auth.presentation.common.validation.use_case.ValidateText
...
open class BaseValidationViewModel @Inject constructor() : ViewModel() {
    ...
    open fun onEvent(event: ValidationEvent) {
        ...
        when (event) {
            ...
            is ValidationEvent.TextFieldValueChange -> {
                ...
                val validate = when (event.state.type) {
                    ...
                    TextFieldType.Date -> ValidateAge()
